                ...
                <div class="card-body">
                    <form action="{{ route('discounts.update', $discount->id) }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="discount_percentage" class="form-label">Nilai Diskon <span
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="is_member_only" class="form-label">Khusus Member <span class="text-danger">*</span></label>
                                    <select class="form-select @error('is_member_only') is-invalid @enderror" id="is_member_only"
                                        name="is_member_only" required>
                                        <option value="0" {{ old('is_member_only', $discount->is_member_only) == 0 ? 'selected' : '' }}>Tidak</option>
                                        <option value="1" {{ old('is_member_only', $discount->is_member_only) == 1 ? 'selected' : '' }}>Ya</option>
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('min_weight') is-invalid @enderror"
                                        id="min_weight" name="min_weight" value="{{ old('min_weight', $discount->min_weight) }}"
                                        step="0.1" min="0">
                                    @error('min_weight')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="feather-save"></i> Update Diskon
                            </button>
                        </div>
                    </form>
                </div>
